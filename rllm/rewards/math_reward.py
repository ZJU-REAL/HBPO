...
class RewardMathFn(RewardFn):
    ...
    def __call__(self, input: RewardInput) -> RewardOutput:
        ...
        if THOUGHT_DELIMITER_END in model_response: #强制有</think>标签
            ...
            # else:
            return RewardOutput(reward=self.config.format_error_reward, is_correct=False,budget=number).to_dict()
        ...
        if ground_truths is None:
            ...
            return RewardOutput(reward=self.config.unk_error_reward, is_correct=False,budget=number).to_dict()
        ...
        for ground_truth in processed_ground_truths:
            ...
            if is_correct and valid_response_length <= 4096:
                ...
                return RewardOutput(reward=reward, is_correct=True,budget=number).to_dict()
        ...
        return RewardOutput(reward=self.config.incorrect_reward, is_correct=False,budget=number).to_dict()
...
if __name__ == "__main__":
    ...
    test_input = RewardInput(
        ...
        metadata={"answer": ["10", "$x^{4}-2 x^{3}-13 x^{2}+14 x+24$"], "has_toolcall": False}
    )
