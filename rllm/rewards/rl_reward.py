...
def rllm_reward_fn(data_source: str, llm_solution: str, ground_truth: Union[str, List[str]], valid_response_length:int, extra_info={}, **kwargs):
    if data_source in ["apps", "taco", "code_contests", "codeforces", "livecodebench", "kodcode", "leetcode", "primeintellect", "humanevalplus"]:
        ...
        return rllm_reward_fn_math(data_source, llm_solution, ground_truth,valid_response_length,extra_info, **kwargs)